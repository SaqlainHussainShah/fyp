...
<!-- end slider -->
    ...
    <form id="searchForm" action="index.php#features" method="get" style="top:-500px; text-align:center;">
    	<h2 >
    	<b style="color:floralwhite;background-color:red;border-radius: 15px 50px;padding:5px 10px 0px 10px;margin-bottom:5px;
